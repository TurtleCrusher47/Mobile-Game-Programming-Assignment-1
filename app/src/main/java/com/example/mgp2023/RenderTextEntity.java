...
public class RenderTextEntity implements EntityBase {
    ...
    public void Init(SurfaceView _view) {
        // Load font
        myfont = Typeface.createFromAsset(_view.getContext().getAssets(), "TechnoRaceItalic-eZRWe.otf");
    ...
    public void Render(Canvas _canvas) {
        ...
        _canvas.drawText("Health: " + GameSystem.Instance.health, 1600, 160, paint);
    }
